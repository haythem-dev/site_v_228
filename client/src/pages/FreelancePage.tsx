...
export default function FreelancePage() {
  ...
  return (
    <div className="pt-12 space-y-10">
      {/* Intro Section */}
      <div id="intro" className="container max-w-5xl space-y-6 pt-6 pb-10">
      ...
      {/* Benefits Section */}
      <div id="benefits" className="container max-w-5xl pt-10 pb-10">
        <h2 className="text-2xl font-bold mb-8">Benefits of Working With Us</h2>
      ...
      {/* FAQ Section */}
      <div id="faq" className="container max-w-5xl pt-10 pb-10 space-y-6">
