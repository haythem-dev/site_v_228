...
export default function Footer() {
  ...
  const contactInfo = [
    {
      icon: <MapPin className="h-5 w-5 text-primary mt-1 mr-3 flex-shrink-0" />,
      content: "123 Business Avenue, Tech Park, San Francisco, CA 94107",
    },
    {
      icon: <Phone className="h-5 w-5 text-primary mt-1 mr-3 flex-shrink-0" />,
      content: "+1 (555) 123-4567",
    },
    {
      icon: <Mail className="h-5 w-5 text-primary mt-1 mr-3 flex-shrink-0" />,
    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Zbenya Systems</h3>
